...
public class Bonus extends Ressources {
	...
	public void pbonus(Bonus bon, Plateau m, Ressources r, Batiment b,
			Population p) {
		int[][] a = new int[10][10];
		for (int i = 0; i < 10; i++) {
			for (int j = 0; j < 10; j++) {
	...
	public void mbonus(Bonus bon, Plateau m, Ressources r, Batiment b,
			Population p) {
		int[][] a = new int[10][10];
		for (int i = 0; i < 10; i++) {
			for (int j = 0; j < 10; j++) {
	 ...
	 * 
	 * Ressources r = new Ressources(); Batiment b = new Batiment(); Bonus bon =
	 * new Bonus(); Population p = new Population(); cbonus(bon, m, r, b, p);
	 * 
	 * }
	 */
