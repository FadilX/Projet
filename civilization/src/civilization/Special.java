...
public class Special {
	...
	public void choixSpecial1(Bonus bonus) {
		...
		System.err.println("Je suis? (Nom de famille sans Maj)");
		reponse = sc.nextLine();
	...
	public void choixSpecial2(Bonus bonus) {
		...
		if (reponse.equals("faraday")) {
			System.err
					.println("Felicitation vous avez débloqué Micheal Faraday");
			System.out
					.println("Vous benificiez d'un bonus de 10 or et 5 nouriture");
			bonus.setBgold(10);
			bonus.setBfood(5);
		} else {
			System.err.println("Mauvaise réponse");
	...
	public void choixSpecial3(Bonus bonus) {
		...
		if (reponse.equals("musk")) {
			...
			System.out
					.println("Vous benificiez d'un bonus de 10 pour toutes les ressources");
			bonus.setBgold(10);
			bonus.setBfood(10);
			bonus.setBwood(10);
			bonus.setBrock(10);
