 ...
 *
 */
public class Buildings extends Map {
	...
	// J'invoque ici l'objet Ressources et Map pour agir durant toutes la durée
	// du programme sur la même entitée
...
*/
	...
	/* public void construct(Map m, Ressources r) {
		int c = 1;
		while (c == 1) {
